    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view,
                ...
                new AlertDialog.Builder(MainActivity.this)
                        ...
                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if(noteList.remove(position)!=null){
               ...
               //return false;;//1.当setOnItemLongClickListener设置的返回值为false时，在Long click时click事件也会触发。
                return true;//当setOnItemLongClickListener设置的返回值为true时，在Long click时click事件不会触发，Long click会关掉click事件。
            }
        });
        //点击悬浮按钮，设置点击事件
